(function () {
    ...
    !(function () {
        ...
        (g = function () {
            ...
            return (
                (e = (i =
                    1 <= arguments.length ? d.call(arguments, 0) : [])[0]),
                (t = i[1]),
                r(e.toFixed(t))
            );
        }),
        ...
        (v.prototype.setTextField = function (t, i) {
        ...
        (V.prototype.render = function () {
            ...
            return (
                (t = this.text
                    ...
                    : r(g(this.displayedValue))),
                (this.elem.innerHTML = t)
            );
        }),
        (i = V),
        t(w, h),
        (w.prototype.displayedValue = 0),
        (w.prototype.value = 0),
        (w.prototype.options = {
            strokeWidth: 0.035,
            length: 0.1,
        ...
        (p = w),
        (S.prototype.updateValues = function (t) {
            return (
                (this.value = t[0]),
                (this.maxValue = t[1]),
                (this.avgValue = t[2]),
        ...
        t(M, s),
        (M.prototype.elem = null),
        (M.prototype.value = [20]),
        (M.prototype.maxValue = 80),
        (M.prototype.minValue = 0),
        (M.prototype.displayedAngle = 0),
        (M.prototype.displayedValue = 0),
        (M.prototype.lineWidth = 40),
        (M.prototype.paddingTop = 0.1),
        (M.prototype.paddingBottom = 0.1),
        (M.prototype.percentColors = null),
        (M.prototype.options = {
            colorStart: "#6fadcf",
            colorStop: void 0,
            gradientType: 0,
        ...
        (M.prototype.setOptions = function (t) {
            ...
            for (
                null == t && (t = null),
                    M.__super__.setOptions.call(this, t),
                ...
                for (
                    ...
                    if (t <= this.percentColors[n].pct) {
                        e =
                            !0 === i
                                ? ((r =
                                      this.percentColors[n - 1] ||
                                      this.percentColors[0]),
                                  (s = this.percentColors[n]),
                                  (a = (t - r.pct) / (s.pct - r.pct)),
                                  {
                                      r: Math.floor(
                                          r.color.r * (1 - a) + s.color.r * a
                                      ),
                                      g: Math.floor(
                                          r.color.g * (1 - a) + s.color.g * a
                                      ),
                                      b: Math.floor(
                                          r.color.b * (1 - a) + s.color.b * a
                                      ),
                                  })
        ...
        (o = M),
        t(C, s),
        (C.prototype.lineWidth = 15),
        (C.prototype.displayedValue = 0),
        (C.prototype.value = 33),
        (C.prototype.maxValue = 80),
        (C.prototype.minValue = 0),
        (C.prototype.options = {
            lineWidth: 0.1,
            colorStart: "#6f6ea0",
            colorStop: "#c0c0db",
        ...
        (C.prototype.setOptions = function (t) {
            return (
                null == t && (t = null),
                C.__super__.setOptions.call(this, t),
        ...
        t(_, (e = C)),
        (_.prototype.strokeGradient = function (t, i, e, s) {
            var n;
            return (
                (n = this.ctx.createRadialGradient(
                    t,
                    i,
                    e,
                    t,
        ...
        (window.AnimationUpdater = {
            ...
            add: function (t) {
                if (x.call(AnimationUpdater.elements, t) < 0)
                    return AnimationUpdater.elements.push(t);
            },
            run: function (t) {
                var i, e, s, n, o, a, h;
                if (
                    (null == t && (t = !1), isFinite(parseFloat(t)) || !0 === t)
                ) {
                    for (
                        i = !0,
                            h = [],
                            s = e = 0,
                            o = (a = AnimationUpdater.elements).length;
                        e < o;
                        s = ++e
                    )
                        a[s].update(!0 === t) ? (i = !1) : h.push(s);
                    for (n = h.length - 1; 0 <= n; n += -1)
                        (s = h[n]), AnimationUpdater.elements.splice(s, 1);
