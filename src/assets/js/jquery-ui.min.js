...
!(function (e) {
    ...
    (l.cleanData =
        ...
        (l.widget = function (e, i, t) {
            ...
            return (
                t || ((t = i), (i = l.Widget)),
                Array.isArray(t) && (t = l.extend.apply(null, [{}].concat(t))),
                ...
                s
                    ? (l.each(s._childConstructors, function (e, t) {
                          var i = t.prototype;
                          l.widget(
        ...
        (l.widget.extend = function (e) {
            for (
                var t, i, s = h.call(arguments, 1), n = 0, a = s.length;
                n < a;
                n++
            )
                for (t in s[n])
                    (i = s[n][t]),
                        o.call(s[n], t) &&
                            void 0 !== i &&
                            (l.isPlainObject(i)
                                ? (e[t] = l.isPlainObject(e[t])
                                      ? l.widget.extend({}, e[t], i)
                                      : l.widget.extend({}, i))
                                : (e[t] = i));
            return e;
        }),
                ...
                return (
                    e
                        ? this.length || "instance" !== i
                            ...
                            : (n = void 0)
                        : (s.length &&
                              (i = l.widget.extend.apply(null, [i].concat(s))),
                          this.each(function () {
                              var e = l.data(this, o);
                              e
                                  ? (e.option(i || {}), e._init && e._init())
                                  : l.data(this, o, new t(i, this));
                          })),
                    n
                );
            };
        ...
        (l.Widget.prototype = {
            ...
            destroy: function () {
                var i = this;
                this._destroy(),
                    l.each(this.classesElementLookup, function (e, t) {
                        i._removeClass(t, e);
                    }),
                    this.element
            ...
            option: function (e, t) {
                ...
                if ("string" == typeof e)
                    if (
                        ...
                        for (
                            s = a[e] = l.widget.extend({}, this.options[e]),
                                n = 0;
                            n < i.length - 1;
                            n++
                        )
            ...
            _classes: function (n) {
                ...
                function e(e, t) {
                    for (var i, s = 0; s < e.length; s++)
                        (i = o.classesElementLookup[e[s]] || l()),
                            (i = n.add
                                ? (n.element.each(function (e, t) {
                                      l
                                          .map(
                                              o.classesElementLookup,
                                              function (e) {
                                                  return e;
                                              }
                                          )
            ...
            _untrackClassesElement: function (i) {
                ...
                l.each(s.classesElementLookup, function (e, t) {
                    -1 !== l.inArray(i.target, t) &&
                        (s.classesElementLookup[e] = l(t.not(i.target).get()));
                }),
                    ...
                    l.each(e, function (e, t) {
                        function i() {
                            if (
                                ...
                                return ("string" == typeof t ? h[t] : t).apply(
                                    h,
                                    arguments
                                );
                        }
                        "string" != typeof t &&
                            (i.guid = t.guid = t.guid || i.guid || l.guid++);
                        var s = e.match(/^([\w:-]*)\s*(.*)$/),
        ...
        l.each({ show: "fadeIn", hide: "fadeOut" }, function (a, o) {
            l.Widget.prototype["_" + a] = function (t, e, i) {
                var s,
                    n = (e = "string" == typeof e ? { effect: e } : e)
                ...
                "number" == typeof (e = e || {})
                    ...
                    s && l.effects && l.effects.effect[n]
                        ? t[a](e)
                        : n !== a && t[n]
    ...
    l.widget("ui.mouse", {
        ...
        _mouseInit: function () {
            ...
            this.element
                ...
                .on("click." + this.widgetName, function (e) {
                    if (
                        !0 ===
                        l.data(e.target, t.widgetName + ".preventClickEvent")
                    )
                        return (
                            l.removeData(
                                e.target,
                ...
                var t = this,
                    ...
                    s =
                        !(
                            ...
                            !e.target.nodeName
                        ) && l(e.target).closest(this.options.cancel).length;
        ...
        l.widget("ui.slider", l.ui.mouse, {
            ...
            _createHandles: function () {
                ...
                (this.handles = i.add(l(s.join("")).appendTo(this.element))),
                    this._addClass(
                        this.handles,
                        "ui-slider-handle",
                        "ui-state-default"
                ...
                e.range
                    ? (!0 === e.range &&
                      ...
                      this.range && this.range.length
                          ...
                          : ((this.range = l("<div>").appendTo(this.element)),
            ...
            _slide: function (e, t, i) {
                ...
                this._hasMultipleValues() &&
                    ...
                    i !== n &&
                        !1 !==
                            this._trigger("slide", e, this._uiHash(t, i, a)) &&
                        (this._hasMultipleValues()
                            ? this.values(t, i)
                            : this.value(i));
            },
            ...
            _values: function (e) {
                ...
                if (arguments.length)
                    return (
                        (e = this.options.values[e]),
                        (e = this._trimAlignValue(e))
                    );
                if (this._hasMultipleValues()) {
                    for (
                        t = this.options.values.slice(), i = 0;
                        i < t.length;
                        i += 1
                    )
